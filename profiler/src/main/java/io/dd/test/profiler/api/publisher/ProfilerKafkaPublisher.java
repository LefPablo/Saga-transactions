package io.dd.test.profiler.api.publisher;
...
public class ProfilerKafkaPublisher {
    ...
    public CompletableFuture<SendResult<String, Object>> sendEvent(ProfilerEvent event) {
